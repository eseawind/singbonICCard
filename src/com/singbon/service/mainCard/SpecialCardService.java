...
//		String sendStr = CardReaderFrame.WriteCard + commandCodeStr + CardReaderFrame.ValidateCardSN + user.getCardSN() + baseBlock0 + baseBlock1 + baseBlock2 + "0000";
...
//		String commandCodeStr = "00" + StringUtil.hexLeftPad(CardReaderCommandCode.LossCashierCard, 4);
//		String sendBufStr = CardReaderFrame.WriteCard + commandCodeStr + CardReaderFrame.ValidateCardSN + sysUser.getCardSN() + cardInfoStr;
...
//		String commandCodeStr = "00" + StringUtil.hexLeftPad(CardReaderCommandCode.UnLossCashierCard, 4);
//		String sendBufStr = CardReaderFrame.WriteCard + commandCodeStr + CardReaderFrame.ValidateCardSN + sysUser.getCardSN() + cardInfoStr;
//		String bufLen = StringUtil.hexLeftPad(2 + sendBufStr.length() / 2, 4);
//		sendBufStr = device.getSn() + StringUtil.hexLeftPad(device.getDeviceNum(), 8) + CommandDevice.NoSubDeviceNum + DeviceType.Main + DeviceType.CardReader + bufLen + sendBufStr;
//		byte[] sendBuf = StringUtil.strTobytes(sendBufStr);
...
//		String commandCodeStr = "00" + StringUtil.hexLeftPad(CardReaderCommandCode.InvalidDateCashierCard, 4);
//		String sendBufStr = CardReaderFrame.WriteCard + commandCodeStr + CardReaderFrame.ValidateCardSN + sysUser.getCardSN() + cardInfoStr;
//		String bufLen = StringUtil.hexLeftPad(2 + sendBufStr.length() / 2, 4);
//		sendBufStr = device.getSn() + StringUtil.hexLeftPad(device.getDeviceNum(), 8) + CommandDevice.NoSubDeviceNum + DeviceType.Main + DeviceType.CardReader + bufLen + sendBufStr;
//		byte[] sendBuf = StringUtil.strTobytes(sendBufStr);

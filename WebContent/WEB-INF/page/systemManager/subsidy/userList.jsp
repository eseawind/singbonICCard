...
<script type="text/javascript">
	...
	function search(){
		...
		$('#pagerForm input[name=deptIds]').val(deptIds);					
		divSearch($('#pagerForm'),'addUserList');
	}
</script>

<div class="pageHeader" style="border: 1px #B8D0D6 solid">
	<form action="${base}/addUserList.do" id="pagerForm">		
			...
			<table border="0">
				...
				<tr>
					<td colspan="12">
						...
						<div class="buttonActive">
							<div class="buttonContent">
								<button type="button" id="addSubsidyFare">添加补助金额</button>
							</div>
						</div>
						<div class="buttonActive" style="margin: 0 5px;">
							<div class="buttonContent">
								<button type="button" id="autoSubsidyFare">自动生成补助金额</button>
							</div>
						</div>
						<div class="buttonActive">
							<div class="buttonContent">
								<button type="button" id="addSubsidy">添加补助准备</button>
							</div>
						</div>
					</td>
				</tr>
	...
	<div class="panelBar">
		<div class="pages">
			<span>每页显示</span> <select class="combox" name="numPerPage"
				onchange="navTabPageBreak({numPerPage:this.value}, 'addUserList')">
		...
		<div class="pagination" rel="addUserList" totalCount="${totalCount }"
